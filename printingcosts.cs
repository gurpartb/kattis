...
namespace printingcost
{
    class Program
    {
        ...
        static Dictionary<char, int> CostMap()
        {
            ...
            {
                costMap.Add(char.Parse(arr[i]), int.Parse(arr[i+1]));
            }
